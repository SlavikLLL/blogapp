  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.categories}>
          ...
          <Image src='/fashion.png' width={32} height={32} className={styles.image} />
          Fashion
          </Link>
          <Link href='/blog?cat=food' className={`${styles.category} ${styles.food}`}>
          <Image src='/food.png' width={32} height={32} className={styles.image} />
          Food
          </Link>
          <Link href='/blog?cat=travel' className={`${styles.category} ${styles.travel}`}>
          <Image src='/travel.png' width={32} height={32} className={styles.image} />
          Travel
          </Link>
          <Link href='/blog?cat=culture' className={`${styles.category} ${styles.culture}`}>
          <Image src='/culture.png' width={32} height={32} className={styles.image} />
          Culture
          </Link>
          <Link href='/blog?cat=coding' className={`${styles.category} ${styles.coding}`}>
          <Image src='/coding.png' width={32} height={32} className={styles.image} />
          Coding
          </Link>
      </div>
    </div>
